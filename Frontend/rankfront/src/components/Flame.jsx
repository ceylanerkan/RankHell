...
// Marka alevi — logo ve yükleme durumunda kullanılır.
// Gradient id'si useId ile üretilir ki aynı sayfada birden fazla alev çakışmasın.
    ...
    <svg viewBox="0 0 24 24" className={className} aria-hidden="true">
      <defs>
        <linearGradient id={id} x1="12" y1="22" x2="12" y2="2" gradientUnits="userSpaceOnUse">
          <stop offset="0" stopColor="var(--color-ember-deep)" />
