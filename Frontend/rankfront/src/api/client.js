...
// Sayfaların ve bileşenlerin beklediği veri şekilleri korunur; backend farklı
// bir şekil döndürdüğünde çeviri burada yapılır, yukarıya sızmaz.
//
// Çoğu akış gerçek backend'e bağlı (http.js üzerinden). HÂLÂ MOCK olan iki
// özellik var, çünkü backend'de karşılığı yok:
//   - getPersonas / votePersona        -> Persona entity'si yok
//   - getRowPickGames / getRowPickGame -> RowPick oyunu yok
// İkisi de aşağıda kendi bölümünde ayrıca işaretli.

import { http, saveSession, clearSession, readUser } from './http'
import { personas, rowPickGames } from './mock/data'

// Ağ gecikmesini taklit eder — yalnızca yukarıdaki mock akışlar için.
